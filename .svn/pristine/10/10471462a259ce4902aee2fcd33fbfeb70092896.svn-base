...
export class ServiceSectionComponent {
  ...
  //   if (direction === 'left') {
  //     this.activeIndex =
  //       this.activeIndex === 0 ? this.services.length - 1 : this.activeIndex - 1;
  //   } else {
  //     this.activeIndex =
  //       this.activeIndex === this.services.length - 1 ? 0 : this.activeIndex + 1;
  //   }
  // }
  ...
  //   const result = [];
  //   for (let i = 0; i < 3; i++) {
  //     result.push(this.services[(this.activeIndex + i) % this.services.length]);
  //   }
  //   return result;
  // }
